...
export default function Post(){
    ...
    useEffect( ()=> {
        ...
        }`).then( (data)=> setPost(data) ).catch( console.log("Not fetch any data") );
    },[]);
    ...
    return (
        <main className="bg-green-100 min-h-screen p-12">
            <section className="container mx-auto">
                ...
                <h2 class="text-lg text-gray-600 flex justify-center mb-12 mt-2">Welcome to my blog post page</h2>
